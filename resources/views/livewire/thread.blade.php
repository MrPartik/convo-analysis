    <div class="bg-white overflow-y-auto scrollbar-thumb-blue scrollbar-thumb-rounded scrollbar-track-blue-lighter scrollbar-w-2 scrolling-touch p-2 rounded-lg" style="height: 80vh; width: 90vw">
        <ul class="tab">
            ...
            <li><a wire:click="getProgramReportData('LUC', true)" href="javascript:" class="tablinks">LUC</a></li>
            <li><a wire:click="getProgramReportData('PRIVATE', true)" href="javascript:" class="tablinks">PRIVATE / PHEIS</a></li>
        </ul>
