<div>
    ...
    <div id="utterance-library" class="bg-white container mx-auto px-4 sm:px-8">
        <div class="loading-page" wire:loading.block wire:target="updateUtterance, nextPage, previousPage, reload">Loading&#8230;</div>
        <div class="py-8">
            <div>
            ...
            <div class="my-2 flex sm:flex-row flex-col">
                <div class="flex flex-row mb-1 sm:mb-0">
                    ...
                    <div class="relative">
                        <button wire:click="reload" title="Reload" type="button" class="mx-3 p-3 inline-flex items-center justify-center rounded-full h-12 w-12 transition duration-500 ease-in-out text-white bg-green-500 hover:bg-green-400 focus:outline-none">
                ...
                <div class="inline-block min-w-full shadow rounded-lg overflow-hidden">
                    ...
                    <div class="px-5 py-5 bg-white border-t flex flex-col xs:flex-row items-center xs:justify-between">
                        <span class="text-xs xs:text-sm text-gray-900">
                            Please click next or previous, data are from realtime. <strong> Current Page : {{ $iPage }} </strong>
                        </span>
